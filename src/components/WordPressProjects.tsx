...
import mittul from '../assets/images/mittul.png';
import yippezy from '../assets/images/yippezy.png';
   ...
   <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://storiesunwired.com" rel="noreferrer" target="_blank">
                <img src={stories} className="zoom" alt="thumbnail" width="100%"/>
                </a>
               <h2><a href="https://storiesunwired.com" rel="noreferrer" target="_blank">Stories Unwired - Figma to Wordpress</a></h2>
            ...
            <div className="project">
                ...
                <img src={accelence} className="zoom" alt="thumbnail" width="100%"/>
                </a>
            ...
            <div className="project">
                ...
                <img src={yippezy} className="zoom" alt="thumbnail" width="100%"/>
                </a>
               <h2><a href="https://yipeezy.net" rel="noreferrer" target="_blank">Yipeezy LLC - Custom Landing Page</a></h2>
                <p>Yipeezy LLC – A clean, responsive custom landing page developed in WordPress to showcase about Business and consulting services.</p>
            </div>
            <div className="project">
